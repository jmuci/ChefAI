 ...
 *
 * This is the list-row primitive — every tappable row in the design (Settings, the profile menu,
 * meal-plan days, shopping-list items) is this modifier plus a `heightIn(min = 44.dp)`:
 *
 * ```
 * Row(
 *     modifier = Modifier
